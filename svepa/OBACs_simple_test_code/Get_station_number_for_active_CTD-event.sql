...
-- when querying the Counter table you can get both the eventIDs but also the counters, which for CTD is necessary for the creation of the serial number (station counter)
select *  
from Counter
